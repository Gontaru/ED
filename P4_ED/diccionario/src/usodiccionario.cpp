...
* @brief fichero para probar el TDA diccionario
*/
...
void ImprimeAlReves(const Diccionario<string,string> &D){
	...
	do{
		--it;
		list<string>::const_iterator it_sig;
		
		cout<< endl << (*it).clave << endl << " informacion asociada: " << endl;

		for(it_sig=(*it).info_asoci.begin(); it_sig!=(*it).info_asoci.end(); ++it_sig){
			cout << (*it_sig) << endl;
		}
...
cout <<endl<<endl<< "Introduzca una palabra: "<<endl;
cin >>a;
cout <<a<<endl;
...
cout <<endl<<endl<< "Dicionario al revés:" << endl;
