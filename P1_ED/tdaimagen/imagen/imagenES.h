...
/**
  ...
  * @param fils filas Parámetro de salida con las filas de la imagen.
  * @param cols columnas Parámetro de salida con las columnas de la imagen.
...
/**
  ...
  * @param fils f filas de la imagen
  * @param cols c columnas de la imagen
  * @return si ha tenido éxito en la escritura.
  */
